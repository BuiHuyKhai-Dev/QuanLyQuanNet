...
(14, 1, 1, 1200000.00, '2025-05-17 00:12:53'),
...
(7, 'Gà xào xả ớt', 0, 45000.00, '2025-05-17 00:30:05');
...
--
ALTER TABLE `phieunhap`
  MODIFY `MaPN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `thucan`
  MODIFY `MaThucAn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
